...
def _common(season: str, last_n_games: int, measure_type: str) -> dict[str, Any]:
    return {
...
def team_stats(*, season: str, last_n_games: int = 0, measure_type: str = "Advanced") -> list[dict[str, Any]]:
    return _fetch("leaguedashteamstats", _common(season, last_n_games, measure_type))


def player_stats(*, season: str, last_n_games: int = 0, measure_type: str = "Base") -> list[dict[str, Any]]:
    return _fetch("leaguedashplayerstats", _common(season, last_n_games, measure_type))
